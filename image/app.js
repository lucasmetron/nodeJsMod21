...
let outputPath = 'C:/Users/dell/Desktop/ProgWeb/mod21NodeJS/image/temp/output_resize.png';

function resize(inputPath, outputPath, width) {

    console.log(inputPath, outputPath, width)
    sharp(inputPath).resize({ width: width })
        .toFile(outputPath, (erro) => {
            if (erro) {
                ...
                compress(outputPath, 'C:/Users/dell/Desktop/ProgWeb/mod21NodeJS/image/compressed/')
            }
        })
